...
This repository keeps the detailed deployment security documentation in
[docs/SECURITY.md](docs/SECURITY.md). That document is the canonical source for
...
- [docs/SECURITY.md](docs/SECURITY.md) -- canonical deployment security guidance
- [docs/operations/code-scanning.md](docs/operations/code-scanning.md) -- scanner inventory, triage rules, and remediation tracking
