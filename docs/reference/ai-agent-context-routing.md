...
| Docs, agent surfaces, skills, adapters | `docs/index.md`, `docs/reference/ai-agent-skills.md`, `docs/reference/ai-agent-integrations.md` | `AGENTS.md`, `CLAUDE.md`, `GEMINI.md`, `.github/`, `.cursor/`, `.agents/skills/`, `tools/lint_docs_structure.py` | `context-budget`, `docs-knowledge-maintainer`, `search-first`, `verification-loop` | `tests/test_lint_docs_structure.py`, AI-surface contract tests |
