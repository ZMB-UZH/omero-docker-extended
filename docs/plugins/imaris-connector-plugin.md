...
- Bio-Formats JAR must be pre-provisioned at `/opt/omero/imarisconvert/bioformats/bioformats_package.jar`; `IMS_Export.py` refuses runtime network download for security.
