...
| -------------------------- | -------------------- | ----------------------------------------------------------------------- | ------------------------------------------ |
| Prometheus                 | v3.12.0              | Metrics scraping and storage                                            | `http://prometheus:9090`                   |
| Grafana                    | 13.1.0               | Dashboards and visualization                                            | `http://grafana:3000`                      |
| Loki                       | 3.7.3                | Log aggregation backend                                                 | `http://loki:3100`                         |
| Alloy                      | v1.17.0              | Log collection pipeline (Docker + files)                                | `http://alloy:12345`                       |
...
| cAdvisor                   | v0.60.3              | Container resource metrics                                              | `http://cadvisor:8080`                     |
...
| Redis exporter             | v1.86.0              | Redis metrics                                                           | `http://redis-exporter:9121`               |
