...
- Production Python lines: `78,635`
- Test Python files: `178`
- Test Python lines: `124,299`
...
- `omeroweb_import/views/core_functions.py`: `9,955` lines
...
- `omeroweb_import/services/ome_zarr_support.py`: `1,108` lines
