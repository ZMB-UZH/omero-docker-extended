...
- Production Python lines: `81,551`
- Test Python files: `181`
- Test Python lines: `130,826`
...
- `omeroweb_import/views/core_functions.py`: `10,367` lines
- `omeroweb_admin_tools/views/index_view.py`: `3,525` lines
