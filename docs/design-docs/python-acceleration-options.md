...
Repository file counts were refreshed on 2026-05-07.
...
- Production Python lines: `73,551`
- Test Python files: `177`
- Test Python lines: `119,626`
...
- `omero_imaris_connector/XTOmeroConnector.py`: `11,924` lines
...
- `tools/regression_guard.py`: `1,405` lines
