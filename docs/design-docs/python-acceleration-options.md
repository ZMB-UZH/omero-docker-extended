...
- Production Python lines: `57,075`
- Test Python files: `176`
- Test Python lines: `88,292`
...
- `omeroweb_imaris_connector/imaris_service.py`: `1,133` lines
- `omeroweb_omp_plugin/views/index_view.py`: `1,121` lines
