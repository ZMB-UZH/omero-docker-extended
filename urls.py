...
urlpatterns = [
    ...
    path("start_delete_all_job/", start_delete_all_job, name="omeroweb_filenamemetadata_start_delete_all_job"),
    path("start_delete_plugin_job/", start_delete_plugin_job, name="omeroweb_filenamemetadata_start_delete_plugin_job"),
