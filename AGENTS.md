...
- `database_plugin` (port 5433): plugin-specific storage (`omp-plugin` user, `omp-plugin` db) -- used by OMP and Upload plugins for user settings, variable sets, AI credentials
