...
urlpatterns = [
    ...
    path(
        "progress/<str:job_id>/", job_progress, name="omeroweb_omp_plugin_job_progress"
    ),
    path("start_acq_job/", start_acq_job, name="omeroweb_omp_plugin_start_acq_job"),
    path(
        "start_delete_all_job/",
        start_delete_all_job,
        name="omeroweb_omp_plugin_start_delete_all_job",
    ),
    path(
        "start_delete_plugin_job/",
        start_delete_plugin_job,
        name="omeroweb_omp_plugin_start_delete_plugin_job",
    ),
    path(
        "delete_all/", delete_all_keyvaluepairs, name="omeroweb_omp_plugin_delete_all"
    ),
    path(
        "delete_plugin/",
        delete_plugin_keyvaluepairs,
        name="omeroweb_omp_plugin_delete_plugin",
    ),
    ...
    path(
        "ai-credentials/",
        list_credentials,
        name="omeroweb_omp_plugin_list_ai_credentials",
    ),
    path(
        "ai-credentials/test/",
        test_credentials,
        name="omeroweb_omp_plugin_test_ai_credentials",
    ),
    path(
        "ai-credentials/save/",
        save_credentials,
        name="omeroweb_omp_plugin_save_ai_credentials",
    ),
    path("ai-credentials/models/", list_models, name="omeroweb_omp_plugin_list_models"),
    path(
        "user-settings/save/",
        save_settings,
        name="omeroweb_omp_plugin_save_user_settings",
    ),
    path(
        "user-data/delete-api-keys/",
        delete_api_keys,
        name="omeroweb_omp_plugin_delete_api_keys",
    ),
    path(
        "user-data/delete-variable-sets/",
        delete_variable_sets,
        name="omeroweb_omp_plugin_delete_variable_sets",
    ),
    path(
        "user-data/delete-all/",
        delete_all_data,
        name="omeroweb_omp_plugin_delete_user_data",
    ),
