"""
Job cleanup utilities for RAM-based job storage.

This module handles automatic cleanup of old job files to prevent RAM accumulation
in the tmpfs-mounted job directory.
"""
...
def cleanup_old_jobs():
    ...
    This is called periodically from the job views to ensure old jobs
    don't accumulate in memory. Since jobs are stored in tmpfs (RAM),
    this prevents memory leaks.
    
    Thread-safe: Multiple simultaneous calls are safe (worst case: redundant cleanup)
    """
