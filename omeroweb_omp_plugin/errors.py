...
def validation_unavailable():
    return (
        "Unable to validate credentials. Please try again later or contact the administrator."
    )
...
def psycopg2_missing():
    return (
        "psycopg2 is not installed. Please install psycopg2-binary in the OMERO.web "
        "environment."
    )
