...
_build_sem_edx_associations_from_entries = _core.build_sem_edx_associations_from_entries
...
_import_job_entry = _core.import_job_entry
_normalize_sem_edx_associations = _core.normalize_sem_edx_associations
_parse_candidate_path_line = _core.parse_candidate_path_line
_process_import_job = _core.process_import_job
...
_start_import_thread = _core.start_import_thread
