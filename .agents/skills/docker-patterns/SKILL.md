...
upstream: third_party/ecc-v1.9.0/skills/docker-patterns/SKILL.md
---
...
Start from `third_party/ecc-v1.9.0/skills/docker-patterns/SKILL.md` for generic container and Compose patterns.
