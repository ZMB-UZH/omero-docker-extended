...
upstream: third_party/ecc-v1.9.0/skills/deployment-patterns/SKILL.md
---
...
Start from `third_party/ecc-v1.9.0/skills/deployment-patterns/SKILL.md` for generic deployment checklists and rollout patterns.
