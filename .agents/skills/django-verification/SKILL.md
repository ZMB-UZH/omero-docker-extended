...
upstream: third_party/ecc-v1.9.0/skills/django-verification/SKILL.md
---
...
Start from `third_party/ecc-v1.9.0/skills/django-verification/SKILL.md` for the generic Django verification flow.
