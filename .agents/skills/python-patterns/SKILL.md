...
upstream: third_party/ecc-v1.9.0/skills/python-patterns/SKILL.md
---
...
Start from `third_party/ecc-v1.9.0/skills/python-patterns/SKILL.md` for the generic Python guidance.
