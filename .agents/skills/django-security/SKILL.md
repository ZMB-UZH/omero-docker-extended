...
upstream: third_party/ecc-v1.9.0/skills/django-security/SKILL.md
---
...
Start from `third_party/ecc-v1.9.0/skills/django-security/SKILL.md` for the generic Django security checklist.
