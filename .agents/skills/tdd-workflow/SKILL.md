...
upstream: third_party/ecc-v1.9.0/skills/tdd-workflow/SKILL.md
---
...
Start from `third_party/ecc-v1.9.0/skills/tdd-workflow/SKILL.md` for the generic red-green-refactor workflow.
