...
upstream: third_party/ecc-v1.9.0/skills/postgres-patterns/SKILL.md
---
...
Start from `third_party/ecc-v1.9.0/skills/postgres-patterns/SKILL.md` for the generic PostgreSQL patterns.
